...
if __name__ == '__main__':
    ...
    q = pandas.read_csv(args.qc, sep='\t', usecols=['barcode', 'total_reads', 'number_umis', 'fraction_mitochondrial'])
    q = q[(q['number_umis']>=args.umi_threshold) & (q['fraction_mitochondrial']<args.mitochondrial_fraction)]
